...
enum APIError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .http(let statusCode, let body):
            ...
            case 408:
                return String(localized: "The server took too long to respond. Check that the server host and connection are available.")
            case 429:
...
private extension APIError {
    ...
    static func networkMessage(for error: Error) -> String {
        ...
        case .timedOut:
            return String(localized: "The server did not respond in time. Check that the server host is available, hermes-webui is running, and the connection is working.")
