...
- Exact app commit: `a7d9c2e`.
- Full XCTest: 1,549 passed, 0 failed, 0 skipped on iPhone 17 / iOS 26.5 Simulator.
- Result bundle: `/tmp/hermex-issue-audit-derived/Logs/Test/Test-HermesMobile-2026.08.01_11-09-15-+0800.xcresult`.
- Signed Debug app: `/tmp/hermex-issue-audit-derived/Build/Products/Debug-iphonesimulator/HermesMobile.app`; `codesign --verify --deep --strict` passed before install.
- #180 picker request: `{"effort":"high","session_id":"normal-session"}`.
